...
public class CloudinaryService {
     ...
     */
    public String uploadImage(MultipartFile file) throws IOException {        // Only attempt Cloudinary if configured with something other than placeholders
        ...
        // Return relative URL so frontend requests it via Nginx /api route
