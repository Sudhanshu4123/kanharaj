...
export const metadata: Metadata = {
  title: "3 BHK Flats in Dwarka Delhi | Luxury Builder Floors | Kanharaj",
  description: "Buy premium 3 BHK flats in Dwarka Delhi with lift, parking & modern amenities. Contact Kanharaj today.",
