                ...
                >
                  ...
                  <div className="flex items-center justify-between px-1 text-slate-400">
                    ...
                    <div className="flex items-center gap-2">
                      ...
                      <a href="https://www.youtube.com/@KanhaRaj4" target="_blank" rel="noopener noreferrer" className="w-7 h-7 rounded-full bg-slate-100 hover:bg-slate-200 hover:text-[#ff0000] flex items-center justify-center transition-colors"><Youtube className="w-3.5 h-3.5" /></a>
                    </div>
                  </div>
                </motion.div>
              )}
