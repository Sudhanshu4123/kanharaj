                ...
                <div className="grid md:grid-cols-2 gap-6">
                  ...
                  <div className="space-y-1.5">
                    ...
                    <div className="relative">
                      <input required type="number" value={propForm.price || 0} onChange={e => setPropForm({ ...propForm, price: Number(e.target.value) })} className="w-full h-11 bg-slate-50 border border-slate-200 rounded-xl pl-4 pr-24 text-xs font-semibold focus:bg-white focus:border-[#dfa127] outline-none transition-all" />
                      {propForm.price ? (
