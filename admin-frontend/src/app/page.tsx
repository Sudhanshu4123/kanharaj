...
export default function DashboardPage() {
  ...
  return (
    <div className="space-y-6">
      ...
      {/* ── 1. Admin Header Spot ── */}
      <div className="bg-gradient-to-r from-[#0a2540] via-[#0d233a] to-[#0a2540] text-white pt-10 pb-20 px-6 md:px-10 relative overflow-hidden rounded-[32px] shadow-sm border border-white/5">
      ...
      {/* ── 2. Stat Grid ── */}
      <div className="max-w-6xl mx-auto px-2 md:px-4 -mt-10 relative z-20 space-y-6">
        ...
        {connError && (
          <div className="bg-rose-50 border border-rose-100 p-6 rounded-3xl flex items-center gap-4 text-rose-700">
            ...
            <div>
              ...
              <p className="text-xs font-semibold text-rose-600/80 leading-relaxed italic">Unable to reach the backend REST API at http://localhost:8080. Please ensure your Spring Boot server is active and the database is configured.</p>
            </div>
          </div>
        )}
          ...
          <div className="bg-[#0a2540] rounded-[2rem] p-8 text-white flex flex-col justify-between shadow-xl border border-white/5 relative overflow-hidden">
            ...
            <div className="relative z-10">
              ...
              <p className="text-white/60 text-xs leading-relaxed font-semibold">
                Use this portal to monitor active platform traffic, verify listings to gain trusted badge status, and modify member roles.
              </p>
            </div>
            <div className="space-y-3 mt-8 relative z-10 border-t border-white/5 pt-4">
              ...
              <div className="flex justify-between text-[10px] font-black uppercase tracking-wider py-1.5">
                <span className="text-white/40">Terminal Mode</span>
