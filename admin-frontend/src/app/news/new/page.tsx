...
export default function NewNewsArticlePage() {
  ...
  const [author, setAuthor] = useState("Kanharaj Admin")
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (res.ok) {
        ...
        setMsg("Error: Failed to save news article.")
        setSaving(false)
      }
    } catch (err) {
      console.error(err)
      ...
      <form onSubmit={handleSubmit} className="bg-white rounded-[2rem] p-8 border border-slate-200 shadow-sm space-y-6">
        ...
        <div className="space-y-1.5">
          ...
          <input
            ...
            placeholder="e.g. Gurgaon Real Estate Demands Soar in Q3 2026"
        ...
        <div className="space-y-1.5">
          ...
          <textarea
            ...
            placeholder="A short 1-2 sentence preview description for card layout..."
            rows={2}
        ...
        <div className="space-y-1.5">
          ...
          <textarea
            ...
            placeholder="Type your news article details here..."
            rows={10}
            className="w-full px-4 py-3 bg-slate-50 border border-slate-200 rounded-xl text-slate-800 font-semibold text-sm outline-none focus:border-[#dfa127]/60 focus:bg-white transition-all shadow-inner"
            required
          />
