...
export default function AddPropertyPage() {
  ...
  const handleImageUpload = async (e: React.ChangeEvent<HTMLInputElement>) => {
    ...
    try {
      ...
      if (result.urls) {
        // Ensure URLs are absolute for preview
  ...
  const handleSubmit = async () => {
    ...
    try {
      // Ensure we send numbers and stringified arrays
      const payload = {
        ...formData,
        ...
        status: "ACTIVE",
        // The backend expects a List<String> for images and amenities
      ...
      if (res.ok) {
        alert("Property Posted Successfully! It is now live on the website.")
        router.push("/listings")
      } else {
        const errorData = await res.json()
        alert(`Failed to post property: ${errorData.message || 'Check your data'}`)
      }
    } catch (err) {
  ...
  return (
    <div className="max-w-4xl mx-auto space-y-8 pb-20">
      <div className="flex items-center justify-between">
        <div>
           <h2 className="text-3xl font-black text-slate-900 tracking-tight">Post New Property</h2>
           <p className="text-slate-500 mt-1">List your property on Kanharaj and reach thousands of buyers.</p>
        </div>
      </div>
      ...
      <div className="dashboard-card min-h-[400px]">
                    ...
                    <div className="grid grid-cols-1 gap-6">
                       <div>
                          ...
                          <input 
                            ...
                            type="text" 
                            placeholder="e.g. Luxury 3 BHK Builder Floor with Lift" 
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                       ...
                       <div>
                          ...
                          >
                             ...
                             <optgroup label="Special / Hospitality">
                    ...
                    <div>
                       ...
                       <div className="relative">
                          ...
                          <textarea 
                            ...
                            onChange={handleInputChange}
                            rows={3}
                            placeholder="e.g. H-45, Sector 7, Near Metro Station, Dwarka" 
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                       <div>
                          ...
                          <input 
                            ...
                            onChange={handleInputChange}
                            type="text" 
                            className="w-full px-5 py-4 rounded-2xl border border-slate-100 focus:ring-2 focus:ring-rose-500 outline-none text-sm font-medium bg-slate-50"
                          />
                       </div>
                       <div>
         ...
         <div className="mt-12 flex items-center justify-between pt-8 border-t border-slate-50">
            ...
            {currentStep < steps.length - 1 ? (
              ...
              >
                 {isSubmitting ? <Loader2 className="animate-spin" size={20} /> : 'Publish Property'}
              </button>
            )}
         </div>
      </div>
