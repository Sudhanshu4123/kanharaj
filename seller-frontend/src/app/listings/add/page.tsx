    ...
    <div className="min-h-screen bg-[#F5F7FA] pb-10">
      ...
      <div className="max-w-[1100px] mx-auto pt-6 md:pt-8 px-4 flex flex-col md:flex-row gap-6 items-start relative z-10">
        ...
        <aside className="w-full md:w-[280px] shrink-0 bg-white rounded-none md:rounded-2xl shadow-md md:shadow-sm border-b border-slate-150 md:border md:border-slate-100 p-3 md:p-6 fixed md:sticky top-14 md:top-24 left-0 right-0 md:left-auto md:right-auto z-30">
          ...
          <Link href="/listings" className="hidden md:inline-flex items-center gap-1 text-xs font-bold text-slate-500 hover:text-slate-800 mb-2 md:mb-6 transition-colors">
            <ChevronLeft className="w-3.5 h-3.5" /> Return to dashboard
          </Link>

          <h1 className="hidden md:block text-xl font-black text-slate-900 leading-tight">Post your property</h1>
          <p className="hidden md:block text-sm font-medium text-slate-500 mb-6">Sell or rent your property</p>

          {subscriptionPlan === "NONE" && (
            <div className="hidden md:block bg-[#0a2540]/5 text-[#0a2540] text-xs font-bold p-3 rounded-xl mb-4 border border-[#0a2540]/10">
          ...
          <div className="md:hidden relative flex items-center justify-between w-full mt-2 px-1 pb-1">
            {/* Connector Line */}
            <div 
              className="absolute top-[14px] h-0.5 bg-slate-100 -z-0"
              style={{ left: `${100 / (2 * activeSteps.length)}%`, right: `${100 / (2 * activeSteps.length)}%` }}
            />
        ...
        <main className="flex-1 bg-white rounded-2xl shadow-sm border border-slate-100 p-6 md:p-10 w-full min-h-[600px] flex flex-col mt-[76px] md:mt-0">
          {subscriptionPlan === "NONE" && (
            <div className="md:hidden bg-[#0a2540]/5 text-[#0a2540] text-xs font-bold p-3 rounded-xl mb-6 border border-[#0a2540]/10">
              Free Listing: {freePostsLimit - freePostsUsed} of {freePostsLimit} free posts remaining.
            </div>
          )}
